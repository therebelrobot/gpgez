...
function _signFile(fullPath) {
  ...
  // sign <filename> [with <privatekey_email_keyID>] [to <outputFilename>] [<message>]
}
...
function _taskEncrypt() {
 ...
 // encrypt [<filename>] [to <outputFilename>] [<message>]

}

function _taskDecrypt() {
  debug('Decrypt function entered')
  // decrypt [<filename>] [with <privatekey_email_keyID>] [to <outputFilename>] [<message>]
}

function _taskVerify() {
  debug('Verify function entered')
  // verify [<filename>] [<message>]
}
